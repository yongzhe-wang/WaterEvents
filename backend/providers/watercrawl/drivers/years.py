...
由 caller 给。[CONFIDENCE: CONFIRMED — self-hosted 替代 drive_archive 的 firecrawl per-year loop].
"""
...
def drive_years(url: str, js_list: list, wait_ms: int = 4000) -> list:
    ...
    no browser / no js_list. Self-hosted replacement for drive_archive's firecrawl one-scrape-per-year loop."""
