...
from .chart import _canon, _hash          # canonical url dedup key + stable content hash — the SAME helpers Chart uses
from .router import classify              # url → KIND_* (html/pdf/pptx/docx/xlsx/audio/video/other)
